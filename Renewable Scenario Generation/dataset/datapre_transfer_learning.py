...
green_rect1 = (32.5, -117.5, 0.8, 0.8)
green_rect2 = (35.2, -119.5, 0.3, 0.8)
...
for file_name in os.listdir(folder_path):
    if file_name.endswith('.csv'):  # check if the file is a csv file
        ...
        if type == 'DPV':
            ...
            elif is_inside_rectangle(latitude, longitude, green_rect2):
                green_data2.append(df)
...
green_data2_15min = process_data(green_data2)

# Save the processed data to npy files
np.save(folder_path + r'\green_data1_15min.npy', green_data1_15min)
np.save(folder_path + r'\green_data2_15min.npy', green_data2_15min)
